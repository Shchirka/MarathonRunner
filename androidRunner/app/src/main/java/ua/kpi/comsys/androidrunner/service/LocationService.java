package ua.kpi.comsys.androidrunner.service;
...
public class LocationService extends Service {
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(@NonNull LocationResult locationResult) {
            ...
            if (locationResult != null && locationResult.getLastLocation() != null) {
                ...
                Log.d("Location update", "onLocationResult: " + latitude + ", " + longitude);
            }
        }
    };
    ...
    private void startLocationService() {
        String channelID = "location_notification_service";
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            if (notificationManager != null &&
                ...
                notificationChannel.setDescription("This channel is used by AndroidRunner");
